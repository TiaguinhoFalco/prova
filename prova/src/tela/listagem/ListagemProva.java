...
import controlador.ControladorProva;
import tela.manutencao.ManutencaoProva;
/**
 *
 * @author Administrador
 */
public class ListagemProva extends javax.swing.JDialog {

    /**
     * Creates new form ListagemProva
     */
    public ListagemProva(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ControladorProva.atualizarTabela(tabela);
    }
...
ManutencaoProva manutencao = new ManutencaoProva(null, true, this);
...
if (evt.getClickCount() == 2) {
            ...
            //abre a manutenção
            ManutencaoProva manutencao = new ManutencaoProva(null, true, this, pk);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemProva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListagemProva dialog = new ListagemProva(new javax.swing.JFrame(), true);
